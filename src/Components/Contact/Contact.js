    ...
    return (
        <div className='contact' name='contact-us'>
            <div className='contact-col'>
                ...
                <ul>
                    <li><img id='email-icon'src={email_icon} alt='Loading'/>lizaeyeco@gmail.com</li>
                    <li><img id='contact-icon' src={contact_icon} alt='Loading'/>+232 76 878779 / +1 623 280-5823</li>
                    <li><img id='location-icon' src={location_icon} alt='Loading'/>N316 Lowcost Housing Kissy, Freetown, Sierra Leone. </li>
                </ul>
            </div>
        </div>
    )
